"""Curated pool of realistic User-Agent strings for anti-fingerprinting."""

from __future__ import annotations

import random

# 30 real-world UAs spanning Chrome / Firefox / Safari across OS versions.
_USER_AGENTS: list[str] = [
    ...
    # Brave (Chromium-based, same UA pattern)
    "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
    # Opera
    ...
    # Googlebot (for testing public APIs that whitelist crawlers)
    "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)",
]


def random_user_agent() -> str:
    """Return a random User-Agent string from the curated pool."""
